...
class CF:
    ...
    def login(self):
        ...
        enter_form['handleOrEmail'] = self.user_id
...
def cf_submit(problem_id, language_name, src_code, url=None, token=None, sid=None):
    with open(os.path.join(pathlib.Path(__file__).parent, 'cf.json')) as fp:
